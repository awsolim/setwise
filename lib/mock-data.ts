import type { Exercise, SavedPlan, WorkoutDay, WorkoutSession } from "@/lib/types";
...
const weekdaySplitExercises: Exercise[] = [
  {
    id: "weekday-incline-db-press-15",
    name: "Incline DB Press (15 degs)",
    muscleGroup: "Chest",
    sets: 3,
    repMin: 12,
    repMax: 12,
  ...
  {
    id: "weekday-unilateral-row-machine",
  ...
  {
    id: "weekday-chest-flies-machine",
    name: "Chest Flies Machine",
    muscleGroup: "Chest",
    sets: 3,
    repMin: 10,
    repMax: 10,
  ...
  {
    id: "weekday-incline-db-press-75",
    name: "Incline DB Press (75 degs)",
    muscleGroup: "Shoulders",
    sets: 3,
    repMin: 12,
    repMax: 12,
  ...
  {
    id: "weekday-cross-cable-tricep-extensions",
  ...
  {
    id: "weekday-rope-tricep-pushdowns",
  ...
  {
    id: "weekday-bulgarian-split-squats-far",
    name: "Bulgarian Split Squats (far leg for glutes)",
    muscleGroup: "Glutes",
    isUnilateral: true,
    sets: 2,
    repMin: 10,
  ...
  {
    id: "weekday-standing-calf-raises",
  ...
  {
    id: "weekday-flat-db-bench-press",
  ...
  {
    id: "weekday-overhead-shoulder-press",
  ...
  {
    id: "weekday-cable-lateral-raises",
...
const weekdaySplitWorkoutDays: WorkoutDay[] = [
  {
    id: "weekday-monday-chest-back",
    dayOfWeek: "Monday",
    title: "Chest / Back",
    exerciseIds: [
      "weekday-incline-db-press-15",
      "weekday-assisted-pullups",
      "weekday-unilateral-row-machine",
      "weekday-chest-flies-machine",
    ],
  },
  {
    id: "weekday-tuesday-shoulders-arms",
    dayOfWeek: "Tuesday",
    title: "Shoulders / Arms",
    exerciseIds: [
      "weekday-incline-db-press-75",
      "weekday-cross-cable-tricep-extensions",
      "weekday-bicep-curls",
      "weekday-rope-tricep-pushdowns",
      "weekday-hammer-curls",
    ],
  },
  {
    id: "weekday-wednesday-legs",
    dayOfWeek: "Wednesday",
    title: "Legs",
    exerciseIds: [
      "weekday-hack-squat",
      "weekday-bulgarian-split-squats-far",
      "weekday-leg-curls",
      "weekday-leg-extensions",
      "weekday-standing-calf-raises",
    ],
  },
  {
    id: "weekday-thursday-upper",
    dayOfWeek: "Thursday",
    title: "Upper",
    exerciseIds: [
      "weekday-flat-db-bench-press",
      "weekday-lat-pulldowns",
      "weekday-overhead-shoulder-press",
      "weekday-cable-lateral-raises",
      "weekday-katana-extensions",
      "weekday-upper-bicep-curls",
    ],
  },
  {
    id: "weekday-friday-legs",
    dayOfWeek: "Friday",
    title: "Legs",
    notes: "Friday leg exercises were not specified yet.",
    exerciseIds: [],
  },
  {
    id: "weekday-saturday-rest",
    dayOfWeek: "Saturday",
    title: "Rest",
    exerciseIds: [],
  },
  {
    id: "weekday-sunday-rest",
    dayOfWeek: "Sunday",
    title: "Rest",
    exerciseIds: [],
  },
...
export const savedPlanTemplates: SavedPlan[] = [
  {
    id: "sample-push-pull-legs",
    name: "Sample Hypertrophy Split",
    description: "The original Setwise sample plan.",
  ...
  {
    id: "weekday-five-day-split",
    name: "5 Day Weekday Split",
    description: "Chest/back, arms, legs, upper, and Friday legs.",
    createdAt: "2026-05-31T00:00:00.000Z",
    updatedAt: "2026-05-31T00:00:00.000Z",
    plan: {
      exercises: weekdaySplitExercises,
      workoutDays: weekdaySplitWorkoutDays,
    },
  },
];
